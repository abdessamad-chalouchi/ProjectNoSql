...
public class SportController {
    ...
    public ResponseEntity<Sport> getSport(@PathVariable String id) {
    ...
    @DeleteMapping(path={"admin/sport/{id}","client/sport/{id}"},produces = {"application/json", "application/xml"})
    public ResponseEntity<Sport> updateSport(@PathVariable String id){
    ...
    public ResponseEntity<?> removeTerrain(@PathVariable("sport_id") String sportId,
