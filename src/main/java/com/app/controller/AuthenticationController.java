...
public class AuthenticationController {
  ...
  @PostMapping(value={"/register/{isClient}"},produces = {"application/json", "application/xml"}, consumes = {"application/json", "application/xml"})
  ...
  @PostMapping(value = {"/authenticate"},produces = {"application/json", "application/xml"}, consumes = {"application/json", "application/xml"})
